...
(function(){
 var lane="*", kind="*", read="*", job="*", mech="*", pers="*", q="";
 ...
 function apply(){
  ...
  ads.forEach(function(a){
   var ok=(kind==="*"||a.dataset.kind===kind)&&(read==="*"||a.dataset.read===read)&&(job==="*"||a.dataset.job===job)&&(mech==="*"||(" "+a.dataset.mech+" ").indexOf(" "+mech+" ")>-1)&&(pers==="*"||a.dataset.pers===pers)&&(q===""||a.dataset.s.indexOf(q)>-1);
